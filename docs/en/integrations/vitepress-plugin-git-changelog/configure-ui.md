...
For specific migration information, see [Migrating from v2 to v3](/en/releases/migrations/v2-to-v3).
...
We have changed the structure of locales config since `2.0.0`, and the old structure will be deprecated in the next major version. Please update your configuration according to the new structure. For migration guides, see [Migrate from v1 to v2](/en/releases/migrations/v1-to-v2).
